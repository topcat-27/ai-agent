...
The eleven reviewed base workflows, any installed optional workflows, three
sample tasks, and enabled Markdown skills
...
9. Imports the eleven base workflows and every installed optional workflow when
